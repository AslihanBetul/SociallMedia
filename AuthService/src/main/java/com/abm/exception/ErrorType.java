...
public enum ErrorType {
    ...
    USER_SERVICE_NOT_UNVALIABLE(1007,"hesabınıza ulaşılamadı",HttpStatus.SERVICE_UNAVAILABLE),
    USER_SERVICE_CAN_NOT_SAVE_USER_PROFILE(1008,"kayıt sırasında sorun oluştu",HttpStatus.SERVICE_UNAVAILABLE),
    REPASSWORDCODE_OR_EMAIL_WRONG(1008,"email ya da repassword kod bulunamadı",HttpStatus.BAD_REQUEST);
