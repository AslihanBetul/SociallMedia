...
public enum ErrorType {
    ...
    USER_HAS_NOT_POST(1007,"post bulunmamaktadır",HttpStatus.BAD_REQUEST),
    POST_NOT_FOUND(1007," böyle bir post bulunmamaktadır",HttpStatus.BAD_REQUEST),
    POST_UPDATE_FAILED(1007," post update edilemez",HttpStatus.BAD_REQUEST);
